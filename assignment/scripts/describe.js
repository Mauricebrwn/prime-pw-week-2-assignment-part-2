...
// We create a condtition where if the code entered is an exact match to '123'
...
// We create a boolean where the isStudent is true, the variable age is set to 34 and the variable zip is 55407.
